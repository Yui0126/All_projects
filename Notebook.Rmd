...
twomore <- data.frame(name = c("Warren Buffett", "Larry Page"), worth_billion = c(109.4, 103.0), age = c(90, 48), source = c("Berkshire Hathaway", "Google"), country = factor(c("United States", "United States")))
...
pnorm(15, 11.2, 2.8, lower.tail = FALSE) # this sets upper value since 15 is more than the mean

#qnorm = what is the value of particular percentile?
